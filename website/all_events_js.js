...
window.onload =function () {
    ...
    req_all_ev_html.open("GET", 'all_events_nun_js.html',true)
    req_all_ev_html.onload=function () {
        var html_rendered = nunjucks.renderString(this.responseText, data);
        var body = document.body;
        body.innerHTML = html_rendered;
    ...
    var req_all_ev_shape_css = new XMLHttpRequest();
    req_all_ev_shape_css.open("GET", 'all_events_shape.css',true)
    req_all_ev_shape_css.onload=function () {
        var css_rendered = nunjucks.renderString(this.responseText, data);
        var ele_inj_css=document.querySelector(".injected_css")
        ele_inj_css.innerHTML=css_rendered
    }
    req_all_ev_shape_css.send()
    ...
    if (!parent_ele.querySelector(".ext-wrapper"))
    {
        window.setTimeout(
            function()
            {
                ...
                req_single_ev_html.open("GET", 'single_event_nun.html',true)
